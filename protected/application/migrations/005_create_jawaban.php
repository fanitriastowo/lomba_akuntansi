...
class Migration_create_jawaban extends CI_Migration {
   ...
   public function up(){
      ...
      $this->dbforge->add_field(
         "CONSTRAINT jawaban_users_fk FOREIGN KEY(user_id) REFERENCES cbt_users(id) ON UPDATE NO ACTION ON DELETE CASCADE");
      $this->dbforge->add_field(
         "CONSTRAINT jawaban_soal_fk FOREIGN KEY(soal_id) REFERENCES cbt_soal(id) ON UPDATE NO ACTION ON DELETE CASCADE");

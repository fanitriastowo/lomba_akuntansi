...
(function($) {
	"use strict";
		...
		//Image Background 
		$(".image-background").backstretch("assets/images/image-bg.jpg");
		...
		$('#clock-countdown').countdown('2017/10/10 07:00:00').on('update.countdown', function(event) {
			var $this = $(this).html(event.strftime(''
				+ '<div class="counter-container"><div class="counter-box first"><div class="number">%-D</div><span>Hari</span></div>'
				+ '<div class="counter-box"><div class="number">%H</div><span>Jam</span></div>'
				+ '<div class="counter-box"><div class="number">%M</div><span>Menit</span></div>'
				+ '<div class="counter-box last"><div class="number">%S</div><span>Detik</span></div></div>'
			));
		});
